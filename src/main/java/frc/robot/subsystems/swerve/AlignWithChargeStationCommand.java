...
public class AlignWithChargeStationCommand extends CommandBase {
  ...
  private final double maxVelocity = 4.95;

  public AlignWithChargeStationCommand(Swerve swerve) {
  ...
  public void execute() {
    ...
    if (!aligned) {
      ...
      swerve.requestVelocity(
        new ChassisSpeeds(xOutput, RobotContainer.dy * maxVelocity, thetaOutput),
        true,
        false
      );
    }
