...
public final class Constants {
  ...
  public static class Drive {
    ...
    public static final boolean[] AZIMUTHS_ARE_REVERSED = {
      false,
      false,
      false,
      false,
    ...
    public static final double MODULE_GEARING =
    ...
    public static final double WHEEL_RADIUS =
      Units.inchesToMeters(2.0) * 0.9442667069;
    public static final Translation2d FIELD_TO_TARGET = new Translation2d(
      Units.feetToMeters(27),
      Units.feetToMeters(13.5)
    );
    public static final double CAMERA_TO_SHOOTER_DISTANCE = Units.inchesToMeters(
      15.0
    );
    public static final double UPPER_HUB_RADIUS =
      Units.inchesToMeters(53.38) / 2;
    public static final double ROBOT_MAX_SPEED =
      (6380.0 * MODULE_GEARING * 2.0 * Math.PI * WHEEL_RADIUS) / 60.0;
    public static final Translation2d FL_LOCATION = new Translation2d(
      ROBOT_LENGTH / 2,
      ROBOT_WIDTH / 2
    );
    public static final Translation2d FR_LOCATION = new Translation2d(
      ROBOT_LENGTH / 2,
      -ROBOT_WIDTH / 2
    );
    public static final Translation2d BL_LOCATION = new Translation2d(
      -ROBOT_LENGTH / 2,
      ROBOT_WIDTH / 2
    );
    public static final Translation2d BR_LOCATION = new Translation2d(
      -ROBOT_LENGTH / 2,
      -ROBOT_WIDTH / 2
    );
  ...
  public static class Elevator {
    ...
    public static final double ELEVATOR_SETPOINT_TOLERANCE = Units.inchesToMeters(
      3.0
    );
    public static final double ELEVATOR_MAX_VELOCITY =
      (6380.0 * ELEVATOR_GEARING * ELEVATOR_PULLEY_PITCH_DIAMETER * Math.PI) /
      60.0;
    ...
    public static final double ELEVATOR_DOUBLE_SUBSTATION_CUBE =
      0.19550697818942656;
  }
  ...
  public static class Arm {
    ...
    public static final TalonFXInvertType ARM_INVERT_TYPE =
      TalonFXInvertType.Clockwise;
    public static final Rotation2d ARM_ENCODER_OFFSET = Rotation2d.fromDegrees(
      0.0
    );
    ...
    public static final double ARM_MAX_VELOCITY =
      ((1.0 / 78.7) * 6380.0 * 360.0) / 60.0;
  ...
  public static class FloorIntake {
    ...
    public static final TalonFXInvertType DEPLOY_INVERT_TYPE =
      TalonFXInvertType.CounterClockwise;
    public static final TalonFXInvertType ROLLER_INVERT_TYPE =
      TalonFXInvertType.CounterClockwise;
    public static final double DEPLOY_MAX_SPEED =
      (6380.0 * DEPLOY_GEAR_RATIO * 360.0) / 60.0;
  ...
  public static class Camera {
    ...
    public static final Transform3d ROBOT_TO_CAM = new Transform3d(
      ...
      new Rotation3d(
        Units.degreesToRadians(0.7496413),
        Units.degreesToRadians(23.6230562),
        0.0
      )
    ); //Units.degreesToRadians(1.6593493)));
  }

  // Constants pertaining to limelight vision
  public static class LimelightVision {
    public static final double CAMERA_HEIGHT_INCHES = 0;
    public static final double TARGET_HEIGHT_INCHES = 0;
